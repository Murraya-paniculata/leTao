              ...
              <li v-for="order in orderList">
                <div class="cart-tab-1">
                  <div class="cart-item-pic">
                    <img :src="'/static/'+order.productImage" alt="XX">
                  </div>
                  ...
                  <div class="item-quantity">
                    <div class="select-self">
                      <div class="select-self-area">
                        <span class="select-ipt">x{{order.productNum}}</span>
                      </div>
                    </div>
          ...
          <div class="price-count">
            <ul>
              ...
              <li class="order-total-price">
                ...
                <span>{{ (this.subtotal+this.shipping+this.discount+this.tax) | currency() }}</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      methods: {
          ...
          payment(){
              axios.post('/users/payment',{
                  ...
                  orderTotal: this.subtotal+this.shipping+this.discount+this.tax
              }).then((response)=>{
                    let res = response.data;
                    if(res.status == '0'){
                        console.log("订单创建成功");
