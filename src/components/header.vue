...
<template>
    <div class="header">
        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    ...
                    <a href="javascript:void(0)" class="navbar-link" @click="loginModalFlag=true"
                       v-if="!userName">Login</a>
                    <a href="javascript:void(0)" class="navbar-link" v-if="userName"
                       @click="LogOut">Logout</a>
                    <div class="navbar-cart-container">
                        <span class="navbar-cart-count"></span>
                        <a v-if="userName" class="navbar-link navbar-cart-link" href="/#/cart">
        ...
        <div class="md-modal modal-meg md-modal-transition" :class="{'md-show': loginModalFlag}">
            <div class="md-modal-inner">
                ...
                <div class="md-content">
                    <div class="confirm-tips">
                        ...
                        <ul>
                            <li class="regi_form_input">
                                ...
                                <input type="password" tabindex="1" name="loginname" v-model="userName" class="regi_login_input">
                            </li>
                        </ul>
                        <ul>
                    ...
                    <div class="login-warp">
                        <a @click= "login" href="javascript:;" class="btn-login">
                            登录
                        </a>
                    </div>
                </div>
